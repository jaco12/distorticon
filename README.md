...
2. In your DAW, open the plugin manager and run a scan so that it can be discovered (e.g., _"Find installed plugins"_ in FL Studio or _"Re-scan"_ in REAPER).
